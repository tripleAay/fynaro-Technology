...
const projectTypes = [
  {
    ...
    title: "Website",
    description: "Business website, company website or web presence.",
    icon: Globe2,
  },
  {
    id: "ecommerce" as ProjectType,
    title: "Ecommerce Store",
    description: "Online store with products, payments and order flows.",
    icon: Globe2,
  },
  {
    id: "mobile" as ProjectType,
    title: "Mobile App",
    description: "A customer, business or custom mobile application.",
    icon: Smartphone,
  },
  {
    id: "product" as ProjectType,
    title: "Digital Product",
    description: "SaaS, portal, dashboard, marketplace or custom system.",
    icon: Layers3,
  },
  {
    id: "brand" as ProjectType,
    title: "Brand Identity",
    description: "Brand direction, identity system and visual language.",
    icon: Palette,
  },
  {
    id: "uiux" as ProjectType,
    title: "UI / UX Design",
    description: "Website, app or product interface design.",
    icon: Palette,
  },
  {
    id: "other" as ProjectType,
    title: "Something Else",
    description: "Tell us what you have in mind and we’ll help shape it.",
    icon: FileText,
  },
];
...
export default function StartProjectPage() {
  ...
  const selectedProject = useMemo(
    () => projectTypes.find((item) => item.id === form.projectType),
    [form.projectType]
  );
        ...
        <div className="mt-7 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-[600px] text-[13px] leading-6 text-black/48">
              You don’t need to know every technical detail. Start with
              what you’re trying to achieve and Fynaro will help shape
              the right scope.
            </p>
          </div>
            ...
            >
              <div className="grid gap-3 sm:grid-cols-2">
                {projectTypes.map((item) => {
                  ...
                  const selected = form.projectType === item.id;
                    ...
                    >
                      ...
                      <p
                        className={[
                          ...
                          selected ? "text-white/50" : "text-black/42",
                        ].join(" ")}
                      >
                        {item.description}
                      </p>
            ...
            >
              <div className="grid gap-3 sm:grid-cols-2">
                {requirements.map((item) => {
                  const selected = form.requirements.includes(item);
            ...
            >
              ...
              <div className="mt-6 rounded-[16px] bg-[#ecece7] p-5">
                <p className="text-[11px] leading-5 text-black/45">
                  This isn’t a final quote. Final pricing is based on
                  scope, functionality, integrations and delivery
                  requirements.
                </p>
              </div>
            </StepContainer>
            ...
            >
              <label className="group flex min-h-[250px] cursor-pointer flex-col items-center justify-center rounded-[20px] border border-dashed border-black/[0.15] bg-white p-8 text-center transition hover:border-black/30">
                ...
                <p className="mt-2 max-w-[390px] text-[11px] leading-5 text-black/40">
                  Drag files here or choose files from your device.
                  PDFs, documents, images and project references can be
                  attached.
                </p>
          ...
          {step === 6 && (
            ...
            >
              <div className="overflow-hidden rounded-[20px] border border-black/[0.09] bg-white">
                <ReviewRow
                  label="Project type"
                  value={selectedProject?.title || "Not selected"}
                />
                ...
                <ReviewRow
                  label="Project"
                  value={form.projectDescription || "Not provided"}
                  multiline
                />
                ...
                <ReviewRow
                  label="Existing URL"
                  value={form.existingUrl || "None provided"}
                />
              </div>
          ...
          <div className="mt-8 flex items-center justify-between border-t border-black/[0.09] pt-6">
            {step > 0 ? (
              <button
                type="button"
                onClick={back}
                className="inline-flex h-11 items-center gap-2 rounded-full px-4 text-[12px] font-semibold text-black/50 transition hover:text-black"
              >
                <ArrowLeft size={14} />
                Back
              </button>
            ...
            {step < steps.length - 1 ? (
              <button
                type="button"
                onClick={next}
                className="inline-flex h-12 items-center gap-3 rounded-full bg-[#111] px-6 text-[12px] font-semibold text-white transition hover:bg-black/80"
              >
                Continue
                <ArrowRight size={14} />
              </button>
          ...
          <div className="sticky top-[100px] rounded-[20px] border border-black/[0.09] bg-white p-6">
            ...
            <div className="mt-6 rounded-[15px] bg-[#f2f2ee] p-4">
              ...
              <p className="mt-2 text-[11px] leading-5 text-black/45">
                You can leave uncertain areas open. Fynaro will help
                define the right technical scope.
              </p>
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="h-13 w-full rounded-[14px] border border-black/[0.1] bg-white px-4 text-[13px] outline-none transition placeholder:text-black/25 focus:border-black/30"
      />
    </label>
  );
}
  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        placeholder={placeholder}
        rows={6}
        className="w-full resize-none rounded-[14px] border border-black/[0.1] bg-white p-4 text-[13px] leading-6 outline-none transition placeholder:text-black/25 focus:border-black/30"
      />
    </label>
  );
}
