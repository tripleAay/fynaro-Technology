...
export default function OrderDetailsPage({
  ...
  searchParams: { orderId?: string; section?: string };
}) {
  // Read orderId from the query string: /shop/order/order-details?orderId=ORD-8847-229
  const displayOrderId = decodeURIComponent(
    searchParams.orderId || FALLBACK_ORDER_ID
  );
  ...
  return (
    <main className="min-h-screen bg-neutral-50 pt-20 pb-16 text-neutral-900">
      {/* Fixed dashboard header (your mainheader component) */}
      <Header />
      ...
      <div className="mx-auto mt-10 max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 flex flex-col gap-2">
          ...
          <nav
            ...
            className="text-[11px] text-neutral-500 sm:text-xs"
          >
        ...
        <div className="mb-8 flex flex-col gap-2 sm:mb-10 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-neutral-500 sm:text-sm">
              Follow the delivery steps, review your items and download your
                  ...
                  return (
                    <li key={step.key} className="relative flex gap-3 sm:gap-4">
                      ...
                      <div className="absolute -left-[29px] flex flex-col items-center sm:-left-[31px]">
                        <span
                          className={`flex h-5 w-5 items-center justify-center rounded-full border text-[10px] sm:h-6 sm:w-6 sm:text-[11px] ${step.done
            ...
            >
              ...
              <div className="space-y-4">
                {orderItems.map((item) => (
                  ...
                  >
                    {/* Simple image placeholder block; swap to real images if you have them */}
