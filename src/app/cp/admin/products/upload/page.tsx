...
export default function UploadProductPage() {
    const [form, setForm] = useState<AppProduct>({
        id: "",
        name: "",
        price: "",
        category: "",
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log("UPLOAD PRODUCT:", payload);

        // later:
        // 1. upload all images to storage
        // 2. save returned URLs to database
    };
        ...
        <div className="max-w-4xl space-y-6">
            ...
            >
                ...
                <div className="flex justify-end">
                    <button
                        type="submit"
                        className="rounded-xl bg-[#d6cc6d] px-6 py-3 text-sm font-medium text-slate-900 transition hover:opacity-90"
                    >
                        Upload Product
                    </button>
                </div>
